...
-- 5c. Streaming insert: orders (only rows with a non-null customer_id)
INSERT INTO iceberg_catalog.demo.orders
SELECT order_id, customer_id, product_id, quantity, unit_price, status, event_time
FROM kafka_orders
